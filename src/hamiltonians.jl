...
function hopping_rotated!(H,t,(c1up,c1dn),(c2up,c2dn), angles1, angles2)
    ...
    mul!(H,c1up',c2up,t*Ω[1,1],1)
    mul!(H,c1dn',c2up,t*Ω[2,1],1)
    mul!(H,c1up',c2dn,t*Ω[1,2],1)
    mul!(H,c1dn',c2dn,t*Ω[2,2],1)
    mul!(H,c2up',c1up,t'*Ω[1,1]',1)
    mul!(H,c2up',c1dn,t'*Ω[2,1]',1)
    mul!(H,c2dn',c1up,t'*Ω[1,2]',1)
    mul!(H,c2dn',c1dn,t'*Ω[2,2]',1)
...
function pairing_rotated!(H,Δ,(c1up,c1dn),(c2up,c2dn),  angles1, angles2)
    ...
    mul!(H,c1up,c2up,Δ*Ω[1,1],1)
    mul!(H,c1dn,c2up,Δ*Ω[2,1],1)
    mul!(H,c1up,c2dn,Δ*Ω[1,2],1)
    mul!(H,c1dn,c2dn,Δ*Ω[2,2],1)
